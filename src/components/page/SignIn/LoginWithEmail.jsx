      ...
      <div className="flex w-full border max-w-sm mx-auto overflow-hidden  rounded-lg shadow-lg  lg:max-w-4xl">
          ...
          <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
              <div className="flex justify-center mx-auto">
                 <Link to='/'> <img className="w-auto rounded-full h-10 sm:h-12" src="https://i.ibb.co/QcPMHwG/Screenshot-2024-08-08-004934.png" alt="" /></Link>
              </div>
              ...
              <div className="flex items-center justify-between mt-4">
                  ...
                  <Link to='/loginN' className="text-xs text-center text-red-500 font-semibold  uppercase hover:underline">login
                      with Number</Link>
              ...
              <div className="mt-4">
                  ...
                  {...register("email",{required: true})}
                   className="block w-full px-4 py-2   border rounded-lg  focus:border-blue-400 focus:ring-opacity-40  focus:outline-none focus:ring focus:ring-blue-300" type="email" placeholder="John@gmail.com" />
              </div>
