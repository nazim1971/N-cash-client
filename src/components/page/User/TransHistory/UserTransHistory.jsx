...
const UserTransHistory = () => {
    ...
    const { data: userAllTrans = [] } = useQuery({
        queryKey: ["userAllTrans"],
        queryFn: async () => {
    ...
    return (
        <div>
         ...
         <Send site={''} title={'All Transactions'} />
            ...
            <div className="">
             ...
             <div className=" mx-8">
             { userAllTrans.length > 0 ?
              userAllTrans.map(i=> <div key={i._id} className="border my-5 flex space-x-4">
                 <img 
